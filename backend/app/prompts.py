...
5. highlights：HighlightItem 列表，**数量按时长动态**(见 user input 的目标范围)。
   ...
   - **类型多样性**:quote/insight/fact/contrarian/story 五种至少各 1 条(内容支持时)
...
- **类型多样性强制要求**:quote / insight / fact / contrarian / story 五种,**至少各 1 条**(内容确实支持时),不要全部挤在某 1-2 种
  - fact(数据点):具体数字、定量结论、对比基准 —— 听众能引用的硬信息,主动挖
  - insight(独到观点):嘉宾的非共识判断、行业洞察 —— 不是常识,是"听完会愣一下"的观点
